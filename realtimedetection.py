...
label = ['Come_Here', 'Deaf', 'Father', 'Friend', 'Hello', 'How_Are_You', 'I_Love_You', 'Love', 'Mother', 'No', 'Please', 'Thank_You', 'What_Are_You_Doing', 'Yes']
while True:
    _,frame = cap.read()
    cv2.rectangle(frame,(150,100),(500,450),(0, 165, 255),1)
